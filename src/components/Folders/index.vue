...
<template>
  <header class="flex justify-center mx-auto mt-8 sm:mb-24">
  ...
  <div v-else>
    <div
      class="grid grid-cols-2 gap-2 md:grid-cols-3 max-w-xs md:max-w-md mx-auto"
    >
  ...
  <div class="flex justify-center max-w-md mx-auto my-8">
    <AddButton @on-click="showAddPopup = true" />
  </div>

  <AddPopup
    v-show="showAddPopup"
    @on-submit="showAddPopup = false"
    @on-cancel="showAddPopup = false"
  />
</template>
